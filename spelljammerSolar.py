...
## Let's make some planet shapes!

# amorph  = Shape("compound")
# turtle.begin_poly()
# turtle.circle(10)
# turtle.penup()
# turtle.left(90)
...
# turtle.pendown()
# turtle.circle(10)
# amorph.addcomponent(turtle.get_poly())
# turtle.register_shape("Amorphous",  amorph)

# belt    = Shape("compound")
# cluster = Shape("compound")
# poly = ()
# flat    = Shape("compound")
# ellip   = Shape("compound")
# d20     = Shape("compound")
# irreg   = Shape("compound")

# turtle.register_shape("Amorphous",  amorph)
# turtle.register_shape("Belt",       belt)
# turtle.register_shape("Cluster",    cluster)
# turtle.register_shape("Sphere",     'circle')
# turtle.register_shape("Cube",       'square')
# turtle.register_shape("Flatworld",  flat)
# turtle.register_shape("Elliptical", ellip)
# turtle.register_shape("Platonic Solid",d20)
# turtle.register_shape("Irregular Shape (go nuts)",irreg)
